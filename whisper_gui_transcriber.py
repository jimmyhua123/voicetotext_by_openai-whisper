...
label = tk.Label(header_frame, text="語音轉文字工具", font=(
    "Arial", 20, "bold"), bg="#f0f8ff", fg="#333", borderwidth=0, highlightthickness=0)
label.grid(row=0, column=0, pady=5)

subtitle_label = tk.Label(header_frame, text="選擇音訊檔案以生成逐字稿或字幕", font=(
    "Arial", 12), bg="#f0f8ff", fg="#555", borderwidth=0, highlightthickness=0)
subtitle_label.grid(row=1, column=0)
subtitle_label = tk.Label(header_frame, text="mp4需先轉成wav or mp3", font=(
    "Arial", 12), bg="#f0f8ff", fg="#555", borderwidth=0, highlightthickness=0)
...
progress_label = tk.Label(status_frame, text="", font=(
    "Arial", 10), bg="#f0f8ff", fg="blue", borderwidth=0, highlightthickness=0)
progress_label.grid(row=0, column=0, pady=5)

timer_label = tk.Label(status_frame, text="", font=(
    "Arial", 10), bg="#f0f8ff", fg="green", borderwidth=0, highlightthickness=0)
timer_label.grid(row=1, column=0, pady=5)

footer_frame = tk.Frame(root, bg="#f0f8ff")
footer_frame.pack(pady=20)

author_label = tk.Label(footer_frame, text="Made by Jimmy Hua", font=(
    "Arial", 10, "italic"), bg="#f0f8ff", fg="#333", borderwidth=0, highlightthickness=0)
